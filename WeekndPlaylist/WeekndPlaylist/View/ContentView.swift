...
//  WeekndPlaylist
//
//  Created by Aditya Gaba on 20/05/23.
...
//
                ...
                VStack{
                    ...
                    VStack {
                        Text("Live Events")
                            ...
                            .bold()
                            .offset(y: -640)
                        Text("The Weeknd: After Hours til Dawn Tour")
                            .font(.system(size: 18))
                            .offset(x : 20)
                            .bold()
                            .foregroundColor(.white)
                            .offset(x: 10 , y:-605)
                        Text("Tue, 6 PM" + " \u{00B7} " + "Telenor Arena, Fornebu ")
                            .font(.system(size: 15))
                            .foregroundColor(.white)
                            .offset(x: -5 , y:-602)
                            .bold()
            ...
            .padding(.bottom, -1480) // Remove bottom padding
        }
    }
}
